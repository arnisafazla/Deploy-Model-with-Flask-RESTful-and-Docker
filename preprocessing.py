...
train_path = os.path.join(PROCESSED_DATA_DIR, os.environ["TRAIN_DATA_FILE"])
test_path = os.path.join(PROCESSED_DATA_DIR, os.environ["TEST_DATA_FILE"])

# Save csv
print("Saving preprocessed data to: {}".format(train_path))
